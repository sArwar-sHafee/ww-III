...
## Game Summary
`ww-III` is a two-player, server-authoritative, real-time, tick-based war game. The server advances time every 1 second. A full game year is 60 seconds, divided into 12 months of 5 seconds each.
