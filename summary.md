...
- Manual trades have a 3-month delay and a 20% fee based on trade value.
- Auto trades execute yearly with a 10% fee based on trade value, and cancelling one costs 20 credits.
